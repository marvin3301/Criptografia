...
int main(void)
{
    ...
    test_decrypt_cbc();
    printf("\nTestando CTR\n\n");
    printf("codigo encriptado:\n");
    test_encrypt_ctr();
    printf("codigo decriptado:\n");
    test_decrypt_ctr();
...
static void test_decrypt_cbc(void)
{
  ...
  AES_CBC_decrypt(buffer, in, 64, key, iv);
...
static void test_encrypt_cbc(void)
{
  ...
  AES_CBC_encrypt(buffer, in, 64, key, iv);
...
static void test_encrypt_ctr(void)
{
    ...
    AES_CTR_encrypt(buffer, in, 64, key, iv);
    for(int i=0;i<16;i++)
...
static void test_decrypt_ctr(void)
{
    ...
    AES_CTR_decrypt(buffer, in, 64, key, iv);
    for(int i=0;i<16;i++)
      printf("%0.2X",buffer[i]);
    printf("\n");
}